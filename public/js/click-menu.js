...
//             $(".sub-ul-drop-right").css("display", "none");
//   });

//       $(".ul-hihi-right li").click(function() {
//             $(".sub-ul-drop-right").slideUp();
//             $(this).find('.sub-ul-drop-right').slideToggle();
//       });

//       $(window).resize(function() {
//             if($(window).width() > 768) {
//                   $(".ul-hihi-right").removeAttr('style');
//             }
//  });
